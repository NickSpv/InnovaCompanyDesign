...
{
    clearLayout(this->ui->formLayout_2);
    //delete this->ui->formLayout_2;
    //this->ui->formLayout_2 = new QFormLayout(this);
...
void MainWindow::on_pushButton_clicked()
{
    ...
    /*for (int i = 0; i < this->ui->formLayout_2->rowCount(); ++i) {
        ...
        QLabel *label;
        try {
            label = qobject_cast<QLabel *>(labelItem->widget());
        } catch(...) {
            label = nullptr;
        }
        ...
        QComboBox *comboBox;
        try {
            comboBox = qobject_cast<QComboBox *>(fieldItem->widget());
        } catch(...) {
            comboBox = nullptr;
        }
